  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh]">
      <div className="card p-8 max-w-md w-full text-center">
        <div className="mx-auto w-14 h-14 rounded-xl bg-blue-600/10 border border-blue-500/20 flex items-center justify-center mb-5">
          <svg width="28" height="28" className="text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <p className="text-sm text-slate-400 mb-6 leading-relaxed">
          ...
          Select a <code className="px-1.5 py-0.5 rounded bg-slate-800 text-blue-400 text-xs">.SemanticModel</code> folder to begin.
        </p>
